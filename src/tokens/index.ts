...
export const colors = {
  ...
  brand: {
    ...
    on: "#0a0a0a", // text color on brand background
  },
  ...
  surface: {
    ...
    raised: "#0f0f0f",    // headers, footers, input bars
    overlay: "#131313",   // cards, chat shell
    elevated: "#1a1a1a",  // elevated cards
    high: "#1e1e1e",      // bubbles, inputs, toggles
    highest: "#2a2a2a",   // borders, dividers
  },
  ...
  chart: {
    ...
    2: "#a3c900",   // olive lime
    3: "#4a5c00",   // deep olive
    4: "#2a3300",   // darkest olive
    5: "#6b6b6b",   // neutral grey
  },
} as const;
...
// ─── Tailwind-compatible flat token map ───────────────────────────────────────
...
// ─── Re-export everything as a single default ─────────────────────────────────
